 ...
 */
final class Version20240226155225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `ordertickets` (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, status INT NOT NULL, purchase_date DATE NOT NULL, INDEX IDX_6EFA6AA2A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE theater (id INT AUTO_INCREMENT NOT NULL, city VARCHAR(255) NOT NULL, longitude DOUBLE PRECISION DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, movie_session_id INT NOT NULL, ordertickets_id INT NOT NULL, seat_id INT NOT NULL, price DOUBLE PRECISION NOT NULL, INDEX IDX_97A0ADA388CF9CE3 (movie_session_id), INDEX IDX_97A0ADA37EC7D47F (ordertickets_id), INDEX IDX_97A0ADA3C1DAFE35 (seat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
